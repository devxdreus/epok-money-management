 ...
 */
public class Anggaran extends javax.swing.JFrame {

    /**
     * Creates new form Anggaran
     */
    public Anggaran() {
        initComponents();
        TambahkanIsiTable();
    ...
    private void TambahkanIsiTable(){
        DefaultTableModel kolomkolom = new DefaultTableModel();
        kolomkolom.addColumn("Kategori");
        kolomkolom.addColumn("Digunakan");
        kolomkolom.addColumn("Total");
        TableAnggaran.setModel(kolomkolom);
        
        List<Map<String, String>> budgets = Budget.getAll();
        
        budgets.forEach(budget -> {
            kolomkolom.addRow(new Object[]{
                budget.get("category_name"),
                budget.get("used"),
                budget.get("total")
        });
        });
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Muhammad  Tommy");
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(780, 720));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Anggaran_Lanjut anggaranLanjut = new Anggaran_Lanjut();
        anggaranLanjut.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Anggaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
